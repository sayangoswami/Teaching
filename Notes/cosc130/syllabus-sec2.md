...
- **When and Where:** Tuesday, Thursday. 9:55 AM - 11:10 AM. Schaefer Hall, Room 165.
...
- **Homework Assignments**  - Programming requires consistent practice, so you will complete several assignments throughout the semester. These involve coding on a laptop or desktop computer. You may use your own device, borrow a **Chromebook** from the Library (first-come, first-served; semester-long loan due May 1 or December 1), or work on **library desktop computers** (Windows) available on the first and second floors. See the [SMCM library computing page](https://library.smcm.edu/services/computers/) for details.
    
- **Quizzes**  - Programming builds on many small concepts that fit together to form larger systems. To help you stay on track, there will be regular quizzes focused on these building blocks.
    
- **Midterm Exam** and **Final Exam**  - These exams will assess your cumulative knowledge and problem-solving skills.
    
- **Programming Project**  - A larger-scale programming project will give you the opportunity to apply what you’ve learned in a more open-ended context.
...
| Week | Date      | Topic                                                                 | Assignment  | Quiz |
| ---- | --------- | --------------------------------------------------------------------- | ----------- | ---- |
| 1    | Jan 20    | Getting started. Quick refresher: types, operators. Setup submission. | A1 out      |      |
|      | Jan 22    | Refresher – branches, loops, arrays                                   |             |      |
| 2    | Jan 27    | Refresher – objects, methods, encapsulation                           | A2 out      | Q1   |
|      | Jan 29    | Motivating example in OOP design                                      |             |      |
| 3    | Feb 3     | Introduction to Object-Oriented Design                                | A3 out      | Q2   |
|      | Feb 5     | Aggregation and Composition                                           |             |      |
| 4    | Feb 10    | Aggregation and Composition (contd.)                                  | A4 out      | Q3   |
|      | Feb 12    | Introduction to Inheritance                                           |             |      |
| 5    | Feb 17    | Inheritance (contd.)                                                  | A5 out      | Q4   |
|      | Feb 19    | Polymorphism II                                                       |             |      |
| 6    | Feb 24    | Polymorphism II                                                       | A6 out      | Q5   |
|      | Feb 26    | Abstract Classes                                                      |             |      |
| 7    | Mar 3     | Interfaces I                                                          | A7 out      | Q6   |
|      | Mar 5     | Interfaces II                                                         |             |      |
...
|      | Mar 26    | Recursion I                                                           |             |      |
| 11   | Mar 31    | Recursion II                                                          | A8 out      | Q7   |
|      | Apr 2     | Java Standard Library - List, Map                                     |             |      |
| 12   | Apr 7     | Generics                                                              | A9 out      | Q8   |
|      | Apr 9     | Generics                                                              |             |      |
| 13   | Apr 14    | Project Kickoff                                                       | A10 out     | Q9   |
|      | Apr 16    | Thanksgiving: No Class                                                |             |      |
| 14   | Apr 21    | Continuation of Project                                               |             | Q10  |
|      | Apr 23    | Continuation of Project                                               |             |      |
| 15   | Apr 28    | Project Completion and Presentation.                                  |             |      |
|      | Apr 30    | Finals Review                                                         | Project Due |      |
| 16   | May 5     | Final Exam review                                                     |             |      |
|      | **May 7** | **Final Exam (9:00 AM – 11:15 AM)**                                   |             |      |

...
1. $\sum_{i=1}^{n} i = n(n+1) / 2$ for $n\geq 0$ 
2. $\sum_{i=1}^{n} i^{2} = n(n+1)(2n+1) / 6$ for $n\geq 0$ 
3. $\sum_{i=1}^{n} i^{3} = n^{2}(n+1)^{2} / 4$ for $n\geq 0$ 
4. $\sum_{i=1}^{n} i(i+1)(i+2) = n(n+1)(n+2)(n+3) / 4$ for $n\geq 0$ 
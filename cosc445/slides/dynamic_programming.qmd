...
# Part 8 — More Examples {background-color="#0d1b2a"}

## Thieving in the Street

**A professional thief** is planning to steal from houses along a street. Each house has a certain amount of money stashed.

**Constraint:** Adjacent houses have a security system — one **cannot steal from two directly adjacent houses**.

**Goal:** Return the maximum amount of money you can steal tonight.
...
Output: 12
Explanation: Steal from house 1 (2) + house 3 (9) + house 5 (1) = 12
```

```
Input:  nums = [1, 2, 3, 1]
Output: 4
Explanation: Steal from house 1 (1) + house 3 (3) = 4
```

. . .

::: {.callout-note title="Hints" .incremental}

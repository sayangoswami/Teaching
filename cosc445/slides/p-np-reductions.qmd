...
**3-SAT:** Given a Boolean formula in Conjunctive Normal Form (CNF) with exactly 3 literals per clause, is there an assignment of variables that makes it true?
...
# Part 5: What Do We Do About Hard Problems? {background-color="#16213e"}
